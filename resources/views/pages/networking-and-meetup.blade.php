      ...
      <section>
        <div class="banner_mainBox">
            <div class="banner_image">
                <img src="{{ENV('APP_URL')}}assets/images/banners/meetup-events.webp" alt="Business Center" class="img-fluid">
            </div>
      ...
      <div class="first_section" data-aos="fade-up" data-aos-duration="1000">
        <div class="container">
          <div class="row justify-content-center text-center">
            <div class="col-md-10">
              <div class="heading">Networking <span>and Meetup</span></div>
              <p>Looking to host a professional networking event, a company launch, or a reward & recognition (R&R) gathering?</p>
              <p>We provide you an end-to-end package right from helping you with event theme, design, venue, launch to creating the perfect environment for successful business networking and impactful team building with magical experience and everlasting memories. </p>
              <p>Impress your guests with a seamless experience backed by professional services.</p>
            </div>
          </div>
        </div>
      </div>
      <div class="premiumServices_section meetup-office-section">
        <div class="container">
          <div class="premiumServices_text" data-aos="fade-up" data-aos-duration="1000">
            ...
            <div class="custom_listing">
              <ul class="p-0">
                ...
                <li>Venue finalization</li>
                <li>Refreshment arrangement</li>
