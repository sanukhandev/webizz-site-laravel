      ...
      <section>
        <div class="banner_mainBox">
          <div class="banner_image">
            <img
              src="{{ENV('APP_URL')}}assets/images/banners/employee-visa.webp"
              alt="Business Center"
              class="img-fluid"
            />
          </div>
      ...
      <div class="first_section" data-aos="fade-up" data-aos-duration="1000">
        <div class="container">
          <div class="row justify-content-center text-center">
            <div class="col-md-10">
              <div class="heading">Employee <span>Visa</span></div>
              <p>
                A UAE Employee Visa is a work residency visa sponsored by a
                company that hires you. It legally allows you to live and work
                in the UAE.
              </p>
            </div>
          </div>
            ...
            <div class="col-md-12">
              <div class="VisaCategory_inner">
                <div class="heading center_heading">
                  Here’s the <span>Full Overview</span>
                </div>
                <table class="table table-responsive">
                  ...
                  <tbody class="align-middle">
                    <tr>
                      <th scope="row">Who sponsors it?</th>
                      <td>The company or employer you work for</td>
                    </tr>
                    <tr>
                      <th scope="row">Visa Type</th>
                      <td>Residency Visa (only 2 year renewal)</td>
                    </tr>
                    <tr>
                      <th scope="row">Who is it for?</th>
                      <td>
                        Anyone who is employed full-time by a UAE-based company
                        (corporate, government, or private sector)
                      </td>
                    </tr>
                  </tbody>
                </table>
